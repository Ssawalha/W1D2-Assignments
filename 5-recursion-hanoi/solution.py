...
def TowerofHanoi(n, start = 'peg 1', destination = 'peg 2', spare = 'peg 3'):
    if n ==1 :
        print ("Move a disk from {} to {}".format(start, destination))
        return
    else:
        TowerofHanoi(n-1, start, spare, destination)
        #print ("Move a disk from {} to {}".format(start, destination))
        TowerofHanoi(1, start, destination, spare)
        TowerofHanoi(n-1, spare, destination, start)
TowerofHanoi(3)